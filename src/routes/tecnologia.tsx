  ...
  return (
    <PageShell>
      <section className="py-12 sm:py-20 px-4 sm:px-6">
        <SectionTitle as="h1" eyebrow="// tech.pulse" title="Tecnología" subtitle="El pulso del mundo digital: lo que pasa hoy y lo que viene mañana." />
      ...
      <section className="py-12 px-4 sm:px-6">
        <div className="mx-auto max-w-4xl glass rounded-2xl p-8 text-center neon-border">
          ...
          <TutorialsSection category="tecnologia" />
    </PageShell>
  );
}

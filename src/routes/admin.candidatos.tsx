...
function CandidatesAdminPage() {
  ...
  return <PageShell><section className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
    <SectionTitle as="h1" eyebrow="// staff control" title="Candidatos a Staff" subtitle="Revisa solicitudes, progreso, evaluaciones y decisiones con historial permanente." />
